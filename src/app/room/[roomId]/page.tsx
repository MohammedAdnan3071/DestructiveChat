    ...
    return <main className="flex flex-col h-screen max-h-screen overflow-hidden">
        ...
        <div className="flex items-center gap-4">
            ...
            <div className=" flex flex-col">
                ...
                <span className={`text-sm font-bold fle items-center gap-2 ${timeRemaining !== null && timeRemaining < 60 ? "text-red-500":" text-amber-500"}`}>
         ...
         <button className="text-xs bg-zinc-800 hover:bg-red-600 px-3 py-1.5 rounded text-zinc-400 hover:text-white font-bold transition-all group flex items-center gap-2 disabled:opacity-50"> 
            <span className="group-hover:animate-pluse">💣</span>
                    DESTROY NOW 
         </button>
        </header>
        ...
        <div className="p-4 border-t border-zinc-800 bg-zinc-900/30">
            ...
            <div className="flex-1 relative group ">
                ...
                autoFocus type="text" className="w-full bg-black border border-zinc-800 focus:border-zinc-700 focus:outline-none transition-colors text-zinc-100 placeholder:text-zinc-700 py-3 pl-8 pr-4 text-sm" />
            </div>
